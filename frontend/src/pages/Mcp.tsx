...
const USE_CASES = [
  { title: "Generate from your IDE", desc: "Call Higgsfield's image and video models directly from Claude, Cursor or any MCP-compatible client." },
...
export default function Mcp() {
  ...
  return (
    <div className="max-w-[900px] mx-auto px-4 py-16 text-center">
      ...
      <h1 className="text-3xl font-extrabold">Higgsfield MCP</h1>
      <p className="text-sm text-ink-muted mt-3 max-w-lg mx-auto">
        The Higgsfield creative engine, available as a Model Context Protocol server — plug image and video
      ...
      >
        {installed ? <><Check size={16} /> Installed</> : "Install Higgsfield MCP"}
      </button>
